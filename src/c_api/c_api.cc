...
int MXKVStoreInit_KVSpecial(KVStoreHandle handle,
                  mx_uint num,
                  const int* keys,
                  NDArrayHandle* vals,
                  const char *pstrType) {
  ...
  static_cast<KVStore*>(handle)->Init_KVSpecial(v_keys, v_vals, strType);
  API_END();
}
...
int MXKVStoreInit_KVSpecialEx(KVStoreHandle handle,
                  mx_uint num,
                  const char** keys,
                  NDArrayHandle* vals,
                  const char *pstrType) {
...
int MXKVStorePush_KVSpecialEx(KVStoreHandle handle,
                  mx_uint num,
                  const char** keys,
                  NDArrayHandle* vals,
                  const char *pstrType,
...
int MXKVStorePull_KVSpecialEx(KVStoreHandle handle,
                  mx_uint num,
                  const char** keys,
                  NDArrayHandle* vals,
                  const char* pstrType,
